...
//        https://sp0.baidu.com/8aQDcjqpAAV3otqbppnN2DJv/api.php?resource_name=guishudi&query=
        String num = et_num.getText().toString().trim();
        final String queryUrl = "https://sp0.baidu.com/8aQDcjqpAAV3otqbppnN2DJv/api.php?resource_name=guishudi&query="+num;
//        parseJSONWithJSONObject(queryUrl, new HttpCallbackListener() {
//            @Override
//            public void onFinshed(String response) {
//                tv_num.setText(response);
//            }
//
//            @Override
